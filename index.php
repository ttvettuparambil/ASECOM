...
<html lang="en">
  ...
  <body class="loading-scroll-hiden">
    ...
    <section id="home" class="home-page">
      <div class="container">
        <div class="row">
          <div class="sub-container col-md-4 col-sm-5 col-xs-12">
            <h1>
              <strong
                >Your partner in Engineering & Project Management
                Services</strong
              >
            </h1>
            <a class="btn btn-kotoby smoothScroll" href="#contact">
              LET's TALK</a
            >
            <a class="btn btn-kotobydown smoothScroll" href="#blog">
...
foreach ($result as $row) {
    ...
    ?>
        ...
        <div class="post">
          <img src="<?=$row['image_path']?>" alt="image1" class="<?=$actives;?>" />
        </div>
        <?php $i++;}?>
              ...
              <div class="footer-description">
                <ul>
                  ...
                  <li>
                    ...
                    <a href="tel:04712964666" class="phone">0471 2964666</a>
                  </li>
                  <li>
